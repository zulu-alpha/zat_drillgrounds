...
hint parseText format [
    "<t align='center'>
    Choose the skill level that the targets will have.
    <br/>
    <br/>Current settings:
...
_action = _interface addAction[("<t color=""#FFBF00"">" + ("10%") + "</t>"), shootHouse_fnc_targetSettings_3_skill_post, [_action_trash, _course, 0.1]];
_action_trash set [count _action_trash, _action];

_action = _interface addAction[("<t color=""#FFBF00"">" + ("25%") + "</t>"), shootHouse_fnc_targetSettings_3_skill_post, [_action_trash, _course, 0.25]];
_action_trash set [count _action_trash, _action];

_action = _interface addAction[("<t color=""#FFBF00"">" + ("50%") + "</t>"), shootHouse_fnc_targetSettings_3_skill_post, [_action_trash, _course, 0.5]];
_action_trash set [count _action_trash, _action];

_action = _interface addAction[("<t color=""#FFBF00"">" + ("75%") + "</t>"), shootHouse_fnc_targetSettings_3_skill_post, [_action_trash, _course, 0.75]];
_action_trash set [count _action_trash, _action];

_action = _interface addAction[("<t color=""#FFBF00"">" + ("100%") + "</t>"), shootHouse_fnc_targetSettings_3_skill_post, [_action_trash, _course, 1]];
_action_trash set [count _action_trash, _action];
